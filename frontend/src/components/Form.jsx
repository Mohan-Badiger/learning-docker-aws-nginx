    ...
    return (
        <div className='flex h-screen justify-center items-center'>
            <div className='flex w-190 h-130'>
                <div className='w-1/2  h-full flex items-center border rounded-l border-r-0 border-indigo-500 p-4'>
                    <div className='w-full'>
                        ...
                        <form onSubmit={handleSubmit} className='flex flex-col gap-4'>
                            ...
                            <button
                                type="submit"
                                className="w-full py-2 bg-indigo-500 mt-5 text-white rounded font-medium hover:bg-indigo-600 transition-colors cursor-pointer"
                            >
                                Login
                            </button>
                        </form>
